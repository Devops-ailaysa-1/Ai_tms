...
# template_global_categoty__template_global_page__tag_name__icontains
    ...
    def list(self,request):
        ...
        if search:
            ...
            queryset = SocialMediaSize.objects.filter(template_global_categoty__template_global_page__tag_name__icontains=search).filter(template_global_categoty__isnull=True)
            print("search",search)
            print("queryset",queryset)
        elif social_media_name_id and search:
            queryset = SocialMediaSize.objects.filter(id=social_media_name_id,template_global_categoty__template_global_page__tag_name__icontains=search).filter(template_global_categoty__isnull=True)
