...
def text_gen_credit_deduct(sender, instance,created, *args, **kwargs):
        ...
        try:
            ...
            if to_deduct.credit_to_deduce != 0 :
                ...
                if status_code != 200:
                    ...
                    to_deduct.save()
                    logger.info(f"Credits Successfully detected for - UID : {instance.user.uid},Credit Deducted : {to_deduct.credit_to_deduce}")
