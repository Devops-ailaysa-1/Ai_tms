...
class SegmentsView(views.APIView, PageNumberPagination):
    ...
    def get(self, request, document_id):
        ...
        print('step-1',page_segments,task.job.project.get_mt_by_page,task.job.project.mt_enable,task.job.project.adaptive_file_translate)
