...
def forwards(apps, schema_editor):
    ...
    task_assign_info = TaskAssignInfo.objects.all()
    for tsk_info in task_assign_info :
        mt_engine = tsk_info.task.job.project.mt_engine
        assign_to =  tsk_info.task.assign_to
        task = tsk_info.task
        ...
        if task_assign:
            ...
            print(f"failed migration for task_assign: tsk_info {tsk_info.id}")
