...
class ProjectFilter(django_filters.FilterSet):
    ...
    def filter_not_empty(self,queryset, name, value):
        ...
        if value == "glossary":
            ...
            queryset = queryset.filter(Q(glossary_project__isnull=True)&Q(voice_proj_detail__isnull=True)).exclude(project_type_id__in = [3,6,7,8])#.exclude(project_file_create_type__file_create_type="From insta text")#.exclude(project_type_id = 5)
        elif value == "designer":
