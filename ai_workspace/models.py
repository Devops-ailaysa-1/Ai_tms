...
class PibFileSegmentChunk(models.Model):
    ...
    task = models.ForeignKey(
        "Task", 
        on_delete=models.CASCADE,
        related_name="segment_chunks"
    )

    # store segment IDs as a list
    segment_ids = models.JSONField()

    chunk_index = models.IntegerField()  # like 0,1,2,...  
    ...
    def __str__(self):
        return f"Chunk {self.chunk_index} - {self.status}"
