...
class VendorsInfo(models.Model):
    ...
    type = models.ForeignKey(VendorLegalCategories,blank=True, null=True, related_name='vendor_legal_type', on_delete=models.CASCADE)
    currency = models.ForeignKey(Currencies,blank=True, null=True, related_name='vendor_currency', on_delete=models.CASCADE)
    vm_status = models.CharField(max_length=200, blank=True, null=True)
...
class VendorServiceInfo(ParanoidModel):
     ...
     mtpe_count_unit=models.ForeignKey(Billingunits,related_name='unit_type', on_delete=models.CASCADE, blank=True, null=True)
...
class VendorServiceTypes(ParanoidModel):
    ...
    services=models.ForeignKey(ServiceTypes,related_name='services', on_delete=models.CASCADE, blank=True, null=True)
