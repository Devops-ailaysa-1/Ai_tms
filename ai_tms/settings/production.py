...
TRANSLATABLE_KEYS_FEDARAL = os.getenv("TRANSLATABLE_KEYS_FEDARAL")
...
TELUGANA_FEDARAL_KEY = os.getenv("TELUGANA-FEDARAL-KEY")
KARNATAKA_FEDARAL_KEY = os.getenv("KARNATAKA-FEDARAL-KEY")
