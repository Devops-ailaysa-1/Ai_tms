...
ADAPTIVE_MIN_LAST_CHUNK = int(os.getenv('ADAPTIVE_MIN_LAST_CHUNK', 150))
ADAPTIVE_STYLE_LLM_MODEL_PIB = os.getenv('ADAPTIVE_STYLE_LLM_MODEL_PIB')
ADAPTIVE_STYLE_LLM_PROVIDER_PIB = os.getenv('ADAPTIVE_STYLE_LLM_PROVIDER_PIB')
ADAPTIVE_TRANSLATE_LLM_MODEL_PIB = os.getenv('ADAPTIVE_TRANSLATE_LLM_MODEL_PIB')

AI_RESEARCH_VERTEX_AI_MODEL_LINK = os.getenv('AI_RESEARCH_VERTEX_AI_MODEL_LINK')
AI_RESEARCH_VERTEX_AI_LOCATION = os.getenv('AI_RESEARCH_VERTEX_AI_LOCATION')
AI_RESEARCH_VERTEX_AI_JSON_PATH = os.getenv('AI_RESEARCH_VERTEX_AI_JSON_PATH')
AI_RESEARCH_VERTEX_AI = os.getenv('AI_RESEARCH_VERTEX_AI')