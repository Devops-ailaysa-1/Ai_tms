...
router.register(r'segment-choice',api_views.SegmentChoicesView,basename='seg-choice')
...
urlpatterns += [
     ...
     path('ai_newscategory',api_views.NewsCategoriesViewset.as_view({'get':'list'}),name='ai-newscategory'),
