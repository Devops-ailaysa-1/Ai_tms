...
router.register(r'pdf-his-list',api_views.PdffileHistorylistViewset,basename='pdf_list')
router.register(r'pdf_public_chat',api_views.PublicBookViewset,basename='pdf_public')
